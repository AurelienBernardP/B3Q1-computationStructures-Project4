...
sort:
  ...
  PUSH(R2)|;Push the size arg1
  BEQ(R31, log2, LP)
  POP(R2) |;pop the argument
  ADDC(R0,0,R3) |;move the result to R3
  PUSH(R3)|;push the arguments
  PUSH(R2)
  PUSH(R1)
  BEQ(R31, introsort, LP)|;call the sort
  POP(R1)|;pop the arguments
  POP(R2)
  POP(R3)
  BEQ(R31, return, R31)|;return
